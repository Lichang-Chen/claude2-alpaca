...
if __name__ == "__main__":
    ...
    parser.add_argument("--load_path", type=str, default="/fs/nexus-scratch/pchiang/llama/7B_sharded")
    parser.add_argument("--save_path", type=str, default="/fs/nexus-scratch/pchiang/llama/7B_new_hf")
