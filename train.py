...
if __name__ == '__main__':
    ...
    parser.add_argument("--init_checkpoint_path", type=str, default="/fs/nexus-scratch/pchiang/llama/7B_sharded")
    parser.add_argument("--model_config_path", type=str, default="/fs/nexus-scratch/pchiang/llama/7B_hf")
    parser.add_argument("--checkpoint_path", type=str, default="/fs/nexus-scratch/pchiang/llama/7B_checkpoint")
    ...
    parser.add_argument("--filtering_method", type=str, choices=["random", "no_shuffle"], default="random")
    parser.add_argument("--num_epochs", type=int, default=3)

    # wandb associated arguments
    parser.add_argument("--wandb", action='store_true')
    parser.add_argument("--wb_project", type=str, default="claude2-alpaca")
    parser.add_argument("--wandb_entity", type=str, default="ksaifullah")
    parser.add_argument("--wb_name", type=str, default="llama2")
