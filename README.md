...
The claude2 alpaca dataset used for training can be found here: [claude2_alpaca](https://huggingface.co/datasets/umd-zhou-lab/claude2_alpaca) <br>
The trained models can be found here: [claude_alpaca-7b](https://huggingface.co/umd-zhou-lab/claude2-alpaca-7B) and [claude_alpaca-13b](https://huggingface.co/umd-zhou-lab/claude2-alpaca-13B)
